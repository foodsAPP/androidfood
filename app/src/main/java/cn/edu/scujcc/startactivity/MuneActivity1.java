...
public class MuneActivity1 extends AppCompatActivity {
...
//        gridView=findViewById(R.id.cookbook_cstar);
        ...
        imAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =new Intent(MuneActivity1.this,UploadActivity.class);
        ...
        imSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(MuneActivity1.this,SerchActivity.class);
                startActivity(intent);
            }
        });
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(MuneActivity1.this).load(list.get(position).getImgUrl()).placeholder(R.mipmap.ic_login_icon).into(viewHolder.img);

            viewHolder.img.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    // TODO: 点击列表跳转到其他页面
                    Intent intent =new Intent(MuneActivity1.this,CheckActivity.class);
                    startActivity(intent);
                }
            });
            return convertView;
